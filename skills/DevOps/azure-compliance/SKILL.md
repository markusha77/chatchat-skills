...
description: Expert hybrid cloud architect specializing in complex multi-cloud solutions across AWS/Azure/GCP and private clouds. Masters hybrid connectivity, workload placement, edge computing, and cross-cloud automation. Handles compliance, cost optimization, disaster recovery, and migration strategies.
category: DevOps
requires: []
examples:
  - "Design a hybrid cloud architecture for Azure and AWS"
  - "Help with Azure compliance and cost optimization"
---
