...
description: "Run a structured standup interview and produce a clear daily update covering yesterday, today, blockers, and discussion topics. Use when users need standup notes, status updates, or daily sync summaries."
category: Business
requires: []
examples:
