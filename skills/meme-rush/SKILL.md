...
2. **Migration Watch**: Monitor tokens about to migrate and catch early DEX liquidity
...
3. `taxRate` for protocol `2001` (Four.meme) only shows on Migrated list; for protocol `2002` (Flap) it shows on all lists
