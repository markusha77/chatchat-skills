...
description: Guidance playbook for WebF Quickstart: plan and execute manually without requiring direct backend/API execution.
category: Blockchain
requires: []
examples:
  - "Set up WebF Go and create my first React app"
  - "Create a Vue project with Vite for WebF"
---

# WebF Quickstart

Provide guidance-only support for WebF Quickstart. Focus on decision quality and practical next actions the user can perform in their own environment.

## Scope

- Core focus: implementation design and integration planning.
- Skill context keywords: webf, quickstart.
- Use this skill when the user wants recommendations, architecture choices, and manual execution steps.

## Guidance Workflow

1. Confirm scope boundaries for implementation design and integration planning and define success criteria.
