...
id: docs-architect
name: Docs Architect
description: Write and improve documentation architecture plans with clear structure, audience fit, useful examples, and maintenance guidance.
category: Documentation
requires: []
examples:
  - "Draft documentation architecture plans for this project so readers can act without guessing."
  - "Review documentation architecture plans for missing prerequisites, stale assumptions, and unclear steps."
---

# Docs Architect

Use this skill when the user is writing, reviewing, or restructuring documentation architecture plans and needs the result to be readable, trustworthy, and genuinely useful after publication.
