...
id: packages
name: Packages
description: Create and maintain package docs with accurate contracts, examples, edge cases, and version-aware detail.
category: Documentation
requires: []
examples:
  - "Create package docs with examples, constraints, and edge-case coverage."
  - "Review package docs for gaps in contracts, parameters, compatibility notes, or failure cases."
---

# Packages

Use this skill when the user needs package docs that readers can trust as a durable lookup source rather than a vague narrative summary.
