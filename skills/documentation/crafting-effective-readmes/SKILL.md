...
description: Write and improve README docs with clear structure, audience fit, useful examples, and maintenance guidance.
category: Documentation
requires: []
examples:
  - "Draft README docs for this project so readers can act without guessing."
  - "Review README docs for missing prerequisites, stale assumptions, and unclear steps."
---

# Crafting Effective READMEs

Use this skill when the user is writing, reviewing, or restructuring README docs and needs the result to be readable, trustworthy, and genuinely useful after publication.
