...
description: Write and improve web design review docs with clear structure, audience fit, useful examples, and maintenance guidance.
category: Documentation
requires: []
examples:
  - "Draft web design review docs for this project so readers can act without guessing."
  - "Review web design review docs for missing prerequisites, stale assumptions, and unclear steps."
---
