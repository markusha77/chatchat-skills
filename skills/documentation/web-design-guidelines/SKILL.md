...
description: Write and improve web design guideline docs with clear structure, audience fit, useful examples, and maintenance guidance.
category: Documentation
requires: []
examples:
  - "Draft web design guideline docs for this project so readers can act without guessing."
  - "Review web design guideline docs for missing prerequisites, stale assumptions, and unclear steps."
---

# Web Design Guidelines

Use this skill when the user is writing, reviewing, or restructuring web design guideline docs and needs the result to be readable, trustworthy, and genuinely useful after publication.
