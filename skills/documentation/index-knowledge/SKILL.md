...
description: Structure knowledge indexing docs so context stays discoverable, bounded, and maintainable without implying hidden system state.
category: Documentation
requires: []
examples:
  - "Design knowledge indexing docs so important context stays discoverable and appropriately scoped."
  - "Review knowledge indexing docs for taxonomy gaps, retrieval friction, and freshness risk."
---

# Index Knowledge

Use this skill when the user needs knowledge indexing docs organized so important context can be captured, found, and updated without implying hidden memory or invisible indexed state.
